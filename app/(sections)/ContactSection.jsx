...
import { Mail, Phone, MapPin, Github, Linkedin, ArrowRight, Send, MessageSquare, Sparkles, CheckCircle } from "lucide-react"
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className={`absolute -inset-0.5 bg-gradient-to-br ${social.color} rounded-xl blur opacity-0 group-hover:opacity-50 transition-opacity duration-300`}></div>
