...
import { ArrowDown, Sparkles, Code2, Zap, Star, Rocket, ChevronRight, Cpu, Globe, CpuIcon as Brain, Palette } from "lucide-react"
...
export default function HomeSection() {
  ...
  // Generate random particles with modern colors
  ...
  const techStack = [
    ...
    { icon: <Brain className="w-5 h-5" />, label: "GenAI" }
  ]
